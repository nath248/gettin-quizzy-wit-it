  ...
  return (
    <div className="results height">
      ...
      <div className="results-content">
        {percent > 0 ? <p>{percent}%</p> : <p>0%</p>}
        {percent >= 75 ? (
          <p>
            Great Job! You're a Certified 90's Kid! <Emoji symbol="💯" />
            <Emoji symbol="🏆" /> You've got {props.score}/{props.total}{" "}
            questions correct
          </p>
        ) : (
          <p>
            Better luck next time! <Emoji symbol="😧" />
            <Emoji symbol="😫" />
            <Emoji symbol="😭" /> You've got {props.score}/{props.total}{" "}
            questions correct
          </p>
        ...
        <Link to="/new" onClick={reset} className="links add-link">
          ADD
        </Link>
      </div>
    </div>
